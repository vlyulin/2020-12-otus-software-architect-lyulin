...
public class AuthRestController {
    ...
    private Logger log = Logger.getLogger(AuthRestController.class.getName());
    ...
    public void login(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        Cookie cookie = new Cookie(SESSION_ID_COOKIE,uuid.toString());
        log.info("Set session_id = " + uuid.toString());
        log.info("Set X-UserId = " + String.valueOf(user.getId()));
    ...
    public void auth(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        String str = request.getHeader(SESSION_ID_COOKIE);
        log.info("Header session_id = "+str);
        if(session_id_cookie == null) {
            log.info("session_id_cookie == null");
            response.sendError(HttpStatus.UNAUTHORIZED.value(), "Unauthorized");
            return;
        }

        log.info("before session_id_cookie.getValue()");
        log.info("session_id_cookie.getValue() = " + session_id_cookie.getValue());
        ...
        log.info("X-UserId = " + String.valueOf(user.getId()));
...
//        response.sendError(HttpStatus.UNAUTHORIZED.value(), "Not authenticated. Please go to login");
